...
func (ms *MySQLrepository) CreateProduct(ctx context.Context, p *Product) (*Product, error) {
...
func (ms *MySQLrepository) GetProduct(ctx context.Context, id int64) (*Product, error) {
	var p Product
...
func (ms *MySQLrepository) ListProducts(ctx context.Context) ([]*Product, error) {
...
func (ms *MySQLrepository) UpdateProduct(ctx context.Context, p *Product) (*Product, error) {
...
func (ms *MySQLrepository) DeleteProduct(ctx context.Context, id int64) error {
...
func (ms *MySQLrepository) CreateOrder(ctx context.Context, o *Order) (*Order, error) {
...
func (ms *MySQLrepository) GetOrder(ctx context.Context, userID int64) (*Order, error) {
	var o Order
...
func (ms *MySQLrepository) GetOrderStatusByID(ctx context.Context, id int64) (*Order, error) {
	var o Order
...
func (ms *MySQLrepository) ListOrders(ctx context.Context) ([]*Order, error) {
	var orders []*Order
...
func (ms *MySQLrepository) UpdateOrderStatus(ctx context.Context, o *Order) (*Order, error) {
...
func (ms *MySQLrepository) DeleteOrder(ctx context.Context, id int64) error {
	err := ms.execTx(ctx, func(tx *sqlx.Tx) error {
...
func (ms *MySQLrepository) execTx(ctx context.Context, fn func(*sqlx.Tx) error) error {
...
func (ms *MySQLrepository) CreateUser(ctx context.Context, u *User) (*User, error) {
...
func (ms *MySQLrepository) GetUser(ctx context.Context, email string) (*User, error) {
	var u User
...
func (ms *MySQLrepository) ListUsers(ctx context.Context) ([]*User, error) {
	var users []*User
...
func (ms *MySQLrepository) UpdateUser(ctx context.Context, u *User) (*User, error) {
...
func (ms *MySQLrepository) DeleteUser(ctx context.Context, id int64) error {
...
func (ms *MySQLrepository) CreateSession(ctx context.Context, s *Session) (*Session, error) {
...
func (ms *MySQLrepository) GetSession(ctx context.Context, id string) (*Session, error) {
	var s Session
...
func (ms *MySQLrepository) RevokeSession(ctx context.Context, id string) error {
...
func (ms *MySQLrepository) DeleteSession(ctx context.Context, id string) error {
...
func (ms *MySQLrepository) EnqueueNotificationEvent(ctx context.Context, ne *NotificationEvent) (*NotificationEvent, error) {
...
func (ms *MySQLrepository) ListNotificationEvents(ctx context.Context) ([]*NotificationEvent, error) {
...
func (ms *MySQLrepository) UpdateNotificationEvent(ctx context.Context, ev *NotificationEvent, es *NotificationState, responseType NotificationResponseType) (bool, error) {
	succeeded := false
	err := ms.execTx(ctx, func(tx *sqlx.Tx) error {
		switch responseType {
